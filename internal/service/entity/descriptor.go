...
// descriptorInstruction is the system prompt for the Entity Descriptor ChatModelAgent.
const descriptorInstruction = `你是一个小说实体描述生成器。根据提供的人物信息，生成一段富描述文本（100-300字）。
...
// newDescriptorAgent creates a ChatModelAgent for entity description generation.
func newDescriptorAgent(ctx context.Context, model einomodel.ToolCallingChatModel) (adk.Agent, error) {
